...
struct PremierLeagueQuestions {
    ...
    func getQuestionText() -> String {
        print(Int(ranNum))
        return PremierQuestion[Int(ranNum)].Question
    }
    
    func getAnswerChoiceOneText() -> String {
        return PremierQuestion[Int(ranNum)].ChoiceOne
    }
    
    func getAnswerChoiceTwoText() -> String {
        return PremierQuestion[Int(ranNum)].ChoiceTwo
    }
    
    func getAnswerChoiceThreeText() -> String {
        return PremierQuestion[Int(ranNum)].ChoiceThree
    }
    
    func getAnswerChoiceFourText() -> String {
        return PremierQuestion[Int(ranNum)].ChoiceFour
    }
    
    func getAnswer() -> String {
        return PremierQuestion[Int(ranNum)].Answer
    }
    ...
    mutating func checkAnswer(userChoice: String) -> Bool {
        if userChoice == PremierQuestion[Int(ranNum)].Answer {
            score += 1
            return true
        } else {
            return false
